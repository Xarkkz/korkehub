...
local GameList = game:HttpGet('https://raw.githubusercontent.com/Xarkkz/korkehub/main/GameList.json')
function GetGame()
...
if Game then
    Supported = true
    Script = game:HttpGet('https://raw.githubusercontent.com/Xarkkz/korkehub/tree/main/Scripts' .. Game.ScriptName)
end
